...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_set, batch_size=2, shuffle=True, num_workers=2, collate_fn=collate_fn)
    val_loader = DataLoader(train_set, batch_size=2, num_workers=2, collate_fn=collate_fn)
